...
void WiFiManager::handleDisconnectEvent(WiFiEvent event, WiFiEventInfo info) {
...
void WiFiManager::addEvents(){
    WiFi.onEvent(handleDisconnectEvent, WiFiEvent_t::ARDUINO_EVENT_WIFI_STA_DISCONNECTED);
}
